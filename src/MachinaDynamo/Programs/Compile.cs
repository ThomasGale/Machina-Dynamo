...
namespace MachinaDynamo
{
    ...
    public partial class Programs
    {
        ...
        public static string Compile(Robot bot, List<MAction> actions, bool inlineTargets = true, bool machinaComments = true, bool conf = false)
        {
            if (bot == null)
            {
            ...
            List<string> codeLines = bot.Compile(inlineTargets, machinaComments, conf);
